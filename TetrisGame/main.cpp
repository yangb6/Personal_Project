...
void additional_student_tests() {
  ...
  // First case, use some wrong input to see the reaction of the function.
    std::cout<<"empty board with width = 6:"<<endl;
    Tetris tetris(6);
    tetris.print();
    std::cout<<"use some wrong input to see the reaction of the function."<<endl;
    std::cout<<endl;
    std::cout<<"add one piece use the code: tetris.add_piece('C',180,2)--it would show: "<<endl;
    tetris.add_piece('C',180,2);
    std::cout<<endl;
    std::cout<<"add one piece use the code: tetris.add_piece('Z',181,3)--it would show: "<<endl;
    tetris.add_piece('Z',181,3);
    std::cout<<endl;
    std::cout<<"add one piece use the code: tetris.add_piece('L',180,8)--it would show: "<<endl;
    tetris.add_piece('L',180,5);
    std::cout<<endl;
    std::cout<<"If we want to remove one column from a board with width = 0, see the reaction of the function."<<endl;
    
    //Add some elements to the board.
    tetris.add_piece('I',90,1);
    tetris.add_piece('J',0,4);
    tetris.add_piece('O',0,0);
    tetris.add_piece('L',0,0);
    tetris.add_piece('O',0,1);
    tetris.add_piece('Z',0,3);
    tetris.print();
    for(int i = 1;i<9;i++)
    {
        std::cout<<"After the "<<i<<" time(s) remove right column"  <<endl;
        tetris.remove_right_column();
        tetris.print();
    }
